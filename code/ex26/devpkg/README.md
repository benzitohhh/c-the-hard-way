...
If on windows, install apr and apr-utils via cygwin installer.
apr and apr-util libraries are already packaged for Cygwin as
libapr1-devel and libaprutil1-devel respectively.

If on linux/OSX, you can install apr/apr utils manually like this:
